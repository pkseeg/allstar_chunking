...
{
       0,     0,     3,     4,     5,     9,    13,    15,    17,    21,
      25,    29,    33,    37,    41,    43,    47,    49,    52,    54,
      58,    60,    62
};
...
{
      13,     0,    -1,    -1,    -1,    13,    14,    15,    -1,    13,
       1,    10,    -1,    10,    -1,     7,    -1,     4,    16,    10,
      -1,     4,    16,     7,    -1,     5,    16,    10,    -1,     5,
      16,     7,    -1,     3,    17,    10,    -1,     3,    17,     7,
      -1,     3,    -1,     3,    11,    16,    -1,    18,    -1,    18,
      17,    -1,    20,    -1,    18,    19,    20,    -1,     9,    -1,
       3,    -1,     8,    -1
};
...
{
       0,   127,   127,   131,   130,   134,   141,   146,   151,   156,
     162,   167,   173,   178,   186,   191,   198,   203,   210,   212,
     218,   221,   226
};
#endif
...
{
  "$end", "error", "$undefined", "SYMBOL", "LIBPATH", "LKRPATH", "PATH",
  "LEXEOF", "NUMBER", "'='", "'\\n'", "';'", "$accept", "program", "@1",
  "line", "path_list", "parameter_list", "e1", "e1op", "e0", 0
};
#endif
...
{
       2,     0,     1,     0,     0,     5,     0,     0,     0,     7,
       6,     4,    21,    22,     0,    16,    18,    14,     0,     0,
      13,    12,    20,    17,     0,     0,     9,     8,    11,    10,
      19,    15
};
...
{
      -9,     1,    -9,    -7,     9,    -9,    15,     6,     6,    -9,
      -9,    -9,    -9,    -9,     0,    12,    -9,    11,    17,    18,
      -9,    -9,    -9,    -9,    15,     6,    -9,    -9,    -9,    -9,
      -9,    -9
};
...
{
      19,     2,     3,     5,    -3,    -3,    -3,    20,    -3,    17,
      21,    -3,     6,     7,     8,    12,     9,    31,    12,    10,
      13,    22,    25,    13,    26,    28,    30,    27,    29,    23
};

static const yytype_uint8 yycheck[] =
{
       8,     0,     1,    10,     3,     4,     5,     7,     7,     3,
      10,    10,     3,     4,     5,     3,     7,    25,     3,    10,
       8,     9,    11,     8,     7,     7,    24,    10,    10,    15
};
...
{
       0,    13,     0,     1,    14,    10,     3,     4,     5,     7,
      10,    15,     3,     8,    17,    18,    20,     3,    16,    16,
       7,    10,     9,    17,    19,    11,     7,    10,     7,    10,
      20,    16
};
...
#line 174 "parse.y"
    {
	  execute_command((yyvsp[(1) - (3)].s), (yyvsp[(2) - (3)].p));
	}
    break;
